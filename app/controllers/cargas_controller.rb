class CargasController < ApplicationController
  ...
  private
    ...
    def carga_params
      params.require(:carga).permit(:user, :cajas, :costoManejo, :alto, :ancho, :largo, :pesoEstimado, :direccion, :valorAsegurado, :nombreDestinatario, :telefonoDestinatario, :recibeSabados, :flete, :fleteTotal, :guia)
    end
end
